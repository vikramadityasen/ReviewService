...
public class ReviewRatingController {
	...
	@GetMapping("/getReviewRatingDetails/{reviewId}")
	public ReviewRatingDetails getReviewRatingDetails(@PathVariable Integer reviewId) {
		return reviewRatingService.getReviewRatingDetails(reviewId);
	}
}
